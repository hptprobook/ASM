        ...
        <div class="form">
          ...
          <div class="form__login text-white">
              <div class="form__login--header d-flex">
                  <div class="form__header--item w-50 text-center">LOGIN</div>
              ...
              <div class="form__login--container">
                  ...
                  <form action="?mod=user&act=login" class="form__login--main" method="POST">
                      <div class="form-group w-100">
                          <input
                              type="text"
                              name="login-username"
                              class="form__login--username"
                      ...
                      <div class="form-group w-100 form-check form__login--check">
                          <input
                              ...
                              ' . ($login_remember ? 'checked' : 'unchecked') . '
                          >
          ...
          <div class="form__register text-white">
              ...
              <div class="form__register--container">
                  ...
                  <form action="?mod=user&act=register" method="POST" class="form__register--main">
                      <div class="form-group w-100">
          ...
          if (isset($_SESSION['is_login']) && $_SESSION['is_login'] === true) {
            echo '
              <div class="top__user--list">
                  <span class="top__user--name">Hello,' . $_SESSION['username'] . '</span>

                  <div class="top__user--handle">
                      <a
                          href="?mod=user&act=profile"
                          class="user__handle--info"
                      >Profile</a>
                      <a href="?mod=user&act=order" class="user__handle--order">Order</a>
                      <a href="?mod=user&act=logout" class="user__handle--logout">Log out</a>
                  </div>
              </div>
            ';
          }
