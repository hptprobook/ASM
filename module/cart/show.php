...
<section class="container cart-table mt-5">
  <form action="?mod=cart&act=update" method="post">
    ...
    <div class="cart-checkout mt-5 mb-5">
      <a href="?mod=cart&act=remove_all">REMOVE ALL</a>
      <button type="submit" class="update-cart-btn" name="update-cart-btn">UPDATE CART</button>
      <a href="?mod=shop">VIEW SHOP</a>
      <a href="?mod=cart&act=checkout" class="float-end checkout-btn">CHECK OUT</a>
    </div>
  </form>
  <style>
    .cart-checkout a,
